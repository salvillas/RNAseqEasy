...
#'
#' @param samplesDir Directory containing Salmon quantification files.
...
load_tximport_data <- function(samplesDir, sample_table, tx2gene) {
  sample_table_dir <- add_sample_path(samplesDir = samplesDir, sample_table = sample_table)
  files <- file.path(samplesDir, sample_table_dir$Folder, "quant.sf")
