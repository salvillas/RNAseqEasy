...
This vignette demonstrates how to use the `RNAseqEasy` package to perform GO enrichment analysis using the `topGO_All()` function. We will use a toy dataset to illustrate the workflow. The main goal is to indentify GO terms representing a list of Genes (e.g., differentially expressed genes) and representing the output in useful plots.
